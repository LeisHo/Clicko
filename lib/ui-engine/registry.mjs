...
// ============================================================
export function createUIElement({ id, role, layout, contexts, domNode }) {
  ...
  elements.set(id, { domNode: domNode || null, role, layout, contexts: initialContexts });
...
export function getElement(id) {
  ...
  return { id, role: entry.role, layout: entry.layout, contexts: entry.contexts, domNode: entry.domNode };
}
